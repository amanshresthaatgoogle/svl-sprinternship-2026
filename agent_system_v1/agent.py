...
# --- Tools ---
def pull_payment_sheet_info(tool_context: ToolContext):
    ...
    # Pass certifi's CA context to urlopen
    ...
    tool_context.state['answer'] = chr(10).join(sections)
...
root_agent = Agent(
    ...
    instruction=f"""
    Call the pull_payment_sheet_info tool and get the response. for all questions, find answers from the response from this tool. 
