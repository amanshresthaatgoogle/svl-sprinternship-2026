...
# 3. Agent System Instruction with target details & SQL query
root_agent = Agent(
    name="heatmap_agent",
    ...
    instruction=(
        ...
        "### TARGET CLOUD SQL INSTANCE PARAMETERS:\n"
        "- project: 'PROJECT_ID'\n"
        ...
        "  );\n\n"
        "### RULES:\n"
        "1. Always supply 'PROJECT_ID' for project, 'free-trial-first-project' for instance, and 'heatmap_db' for database in tool calls.\n"
